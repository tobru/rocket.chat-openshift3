...
Slingshot.fileRestrictions('rocketchat-uploads', {                                                                     // 3
	authorize: function (file /*, metaContext*/) {                                                                        // 4
		if (!RocketChat.fileUploadIsValidContentType(file.type)) {                                                           // 5
			throw new Meteor.Error(TAPi18n.__('error-invalid-file-type'));                                                      // 6
		}                                                                                                                    //
                                                                                                                       //
...
FileUpload = {                                                                                                         // 6
	validateFileUpload: function (file) {                                                                                 // 7
		if (file.size > maxFileSize) {                                                                                       // 8
			throw new Meteor.Error('error-file-too-large', 'File is too large');                                                // 9
		}                                                                                                                    //
                                                                                                                       //
		if (!RocketChat.fileUploadIsValidContentType(file.type)) {                                                           // 12
			throw new Meteor.Error('error-invalid-file-type', 'File type is not accepted');                                     // 13
		}                                                                                                                    //
                                                                                                                       //
		return true;                                                                                                         // 16
	}                                                                                                                     //
...
RocketChat.settings.get('FileUpload_S3_AWSSecretAccessKey', function (key, value) {                                    // 115
	...
	createS3Directive();                                                                                                  // 117
                                                                                                                       ...
                                                                                                                       //
RocketChat.settings.get('FileUpload_S3_CDN', createS3Directive);                                                       // 120
                                                                                                                       //
RocketChat.settings.get('FileUpload_S3_Region', createS3Directive);                                                    // 122
                                                                                                                       //
RocketChat.settings.get('FileUpload_S3_BucketURL', createS3Directive);                                                 // 124
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
FileUpload.addHandler('rocketchat_uploads', {                                                                          // 48
	get: function (file, req, res) {                                                                                      // 49
		var headers = {                                                                                                      // 50
			'Content-Disposition': 'attachment; filename="' + encodeURIComponent(file.name) + '"',                              // 51
			'Last-Modified': file.uploadedAt.toUTCString(),                                                                     // 52
			'Content-Type': file.type,                                                                                          // 53
			'Content-Length': file.size                                                                                         // 54
		};                                                                                                                   //
		return readFromGridFS(file.store, file._id, file, headers, req, res);                                                // 56
	},                                                                                                                    //
	'delete': function (file) {                                                                                           // 58
		return Meteor.fileStore['delete'](file._id);                                                                         // 59
	}                                                                                                                     //
});                                                                                                                    //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
